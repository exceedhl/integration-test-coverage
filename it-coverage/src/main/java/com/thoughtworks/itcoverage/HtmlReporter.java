...
public class HtmlReporter {
    ...
    public HtmlReporter(TestCoverageCalculator testCoverageCalculator, String outputDir) {
    ...
    public void generateReport() throws IOException {
        ...
        Writer w = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream(new File(outputDir + File.separator + IT_COVERAGE_REPORT_RESULT_HTML_FILE)), "UTF-8"));
